...
class HapticsSettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if UIDevice.current.userInterfaceIdiom == .phone {
            navigationItem.title = NSLocalizedString("settings.soundsAndHaptics", comment: "")
        } else {
            navigationItem.title = NSLocalizedString("settings.soundsAndHaptics.sounds", comment: "")
        }
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "UITableViewCell0")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            switchView.addTarget(self, action: #selector(switchSounds(_:)), for: .valueChanged)
