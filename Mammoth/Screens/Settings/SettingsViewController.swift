...
class SettingsViewController: UIViewController {
    ...
    init(expandUpgradeCell: Bool = false) {
        ...
        upgradeCellIsExpanded = expandUpgradeCell
    }
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = .custom.backgroundTint
        navigationItem.title = NSLocalizedString("title.settings", comment: "")
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(scrollToTop), name: NSNotification.Name(rawValue: "scrollToTop9"), object: nil)
        ...
        tableView.register(UpgradeCell.self, forCellReuseIdentifier: UpgradeCell.reuseIdentifier)
        tableView.alpha = 1
...
extension SettingsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch item {
        case .upgrade:
            upgradeCellIsExpanded = !upgradeCellIsExpanded
            if #available(iOS 15.0, *) {
...
extension SettingsViewController {
    func postClearCacheAlert() {
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("settings.clearData.confirm", comment: ""), style: .destructive, handler: { _ in
            self.clearAllCaches()
        }))
