...
public extension SKPhoto {
    static func photoWithImage(_ image: UIImage) -> SKPhoto {
        return SKPhoto(image: image)
    }

    static func photoWithImageURL(_ url: String) -> SKPhoto {
        return SKPhoto(url: url)
    }

    static func photoWithImageURL(_ url: String, holder: UIImage?) -> SKPhoto {
