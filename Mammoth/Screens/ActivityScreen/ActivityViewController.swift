...
class ActivityViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = NSLocalizedString("title.activity", comment: "")
        title = NSLocalizedString("title.activity", comment: "")
    }
    ...
    private func setupUI() {
        ...
        headerView.carousel.content = ["activity.all", "activity.likes", "activity.reposts", "activity.follows", "activity.posts"].map { NSLocalizedString($0, comment: "") }
    }
}
