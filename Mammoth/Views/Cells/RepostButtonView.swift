...
class RepostButtonView: UIView {
    ...
    private func commonInit() {
        ...
        addSubview(repostOverlayButton)
        ...
        addConstraints([
            leftAnchor.constraint(equalTo: repostOverlayButton.leftAnchor, constant: 8),
            topAnchor.constraint(equalTo: repostOverlayButton.topAnchor, constant: 8),
            bottomAnchor.constraint(equalTo: repostOverlayButton.bottomAnchor, constant: -8),
            rightAnchor.constraint(equalTo: repostOverlayButton.rightAnchor, constant: -8),
        ])
    }
}
