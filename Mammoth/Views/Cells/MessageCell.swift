    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[bgView]-0-|", options: [], metrics: nil, views: viewsDict))
            ...
            if GlobalStruct.singleColumn {
                contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-85-[bgView]-85-|", options: [], metrics: nil, views: viewsDict))
            } else {
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(50)]-12-[userName]-4-[userTag]-(>=20)-[indi(8)]-4-[dateTime]-16-|", options: [], metrics: nil, views: viewsDict))
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(offset)-[indi(8)]", options: [], metrics: metricsDict, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-14-[dateTime]", options: [], metrics: nil, views: viewsDict))
    }
