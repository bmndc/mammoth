    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[bgView]-0-|", options: [], metrics: nil, views: viewsDict))
            ...
            if GlobalStruct.singleColumn {
                contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[bgView]-10-|", options: [], metrics: nil, views: viewsDict))
            } else {
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-52-[lockedBadge(20)]", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-46-[lockedBadge(20)]", options: [], metrics: nil, views: viewsDict))

        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(50)]-12-[userName]-4-[userTag]-(>=16)-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(50)]-12-[bioText]-16-|", options: [], metrics: nil, views: viewsDict))

        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-14-[profileIcon(50)]-(>=14)-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-14-[userName]-0-[bioText]-14-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-14-[userTag]-0-[bioText]", options: [], metrics: nil, views: viewsDict))
    }
...
class AccountCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        bioText.emailColor = .custom.baseTint
        bioText.urlMaximumLength = 30
        bioText.handleMentionTap { _ in }
        bioText.handleHashtagTap { _ in }
        bioText.handleURLTap { _ in }
        bioText.handleEmailTap { _ in }
        bgView.addSubview(bioText)
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(44)]-12-[userName]-(>=16)-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(44)]-12-[userTag]-(>=16)-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(44)]-12-[bioText]-16-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[profileIcon(44)]-12-[signOutButton]-(>=16)-|", options: [], metrics: nil, views: viewsDict))

        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-14-[profileIcon(44)]-(>=14)-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-14-[userName]-0-[userTag]-3-[bioText]-10-[signOutButton]-14-|", options: [], metrics: nil, views: viewsDict))
    }
