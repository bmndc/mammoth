...
class SwiftyGiphyCollectionViewCell: UICollectionViewCell {
    fileprivate(set) var imageView: UIImageView = .init()
    ...
    fileprivate func setup() {
        ...
        NSLayoutConstraint.activate([
            backgroundRoundedCornerView.leftAnchor.constraint(equalTo: contentView.leftAnchor),
            backgroundRoundedCornerView.topAnchor.constraint(equalTo: contentView.topAnchor),
            backgroundRoundedCornerView.rightAnchor.constraint(equalTo: contentView.rightAnchor),
            backgroundRoundedCornerView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor),
        ])
