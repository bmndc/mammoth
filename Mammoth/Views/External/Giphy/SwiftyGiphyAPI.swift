...
private typealias GiphyAPIResponseBlock = (_ error: NSError?, _ response: [String: AnyObject]?) -> Void

private let kGiphyUnknownResponseError = NSLocalizedString("composer.giphy.error", comment: "")

private let kGiphyDefaultAPIBase = URL(string: "https://api.giphy.com/v1/gifs/")!
private let kGiphyDefaultStickerAPIBase = URL(string: "https://api.giphy.com/v1/stickers/")!
...
public class SwiftyGiphyAPI {
    ...
    public static let shared: SwiftyGiphyAPI = .init()
    ...
    private var isUsingDefaultAPIBase: Bool {
        return giphyAPIBase == kGiphyDefaultAPIBase
    }

    private var isUsingDefaultStickerAPIBase: Bool {
     ...
     */
    private func send(request: URLRequest, completion: GiphyAPIResponseBlock?) {
    ...
    private func networkError(description: String) -> NSError {
     ...
     */
    private func createRequest(baseURL: URL, relativePath: String, method: String, params: [String: Any]?) -> URLRequest {
