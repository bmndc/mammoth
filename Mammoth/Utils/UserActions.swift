...
enum UserActions {
    ...
    static func onFiltersTap(target: UIViewController, user _: UserCardModel) {
        triggerHapticImpact(style: .light)
    ...
    static func onBookmarksTap(target: UIViewController, user _: UserCardModel) {
        triggerHapticImpact(style: .light)
    ...
    static func onLikesTap(target: UIViewController, user _: UserCardModel) {
        triggerHapticImpact(style: .light)
    ...
    static func onEditDetails(target: UIViewController, user _: UserCardModel) {
    ...
    static func onFollow(target _: UIViewController, user: Account) {
    ...
    static func onUnfollow(target _: UIViewController, user: Account) {
    ...
    static func onMute(target _: UIViewController, user: Account) {
        ModerationManager.shared.mute(user: user)
    }

    static func onMuteOneDay(target _: UIViewController, user: Account) {
        let duration = 86400
        ModerationManager.shared.mute(user: user, durationInSeconds: duration)
    }

    static func onBlock(target _: UIViewController, user: Account) {
