...
extension UIColor {
    ...
    static func getGradientLayer(colors: [CGColor], startPoint: CGPoint, endPoint: CGPoint, bounds: CGRect) -> CAGradientLayer {
    ...
    static func gradient(colors: [CGColor], startPoint: CGPoint, endPoint: CGPoint, bounds: CGRect) -> UIColor? {
        let gradientLayer = getGradientLayer(colors: colors, startPoint: startPoint, endPoint: endPoint, bounds: bounds)
