...
public extension Date {
    ...
    func toString(dateStyle _: DateFormatter.Style, timeStyle: DateFormatter.Style, isRelative _: Bool = false, timeZone _: Foundation.TimeZone = Foundation.NSTimeZone.local, locale _: Locale = Locale.current) -> String {
...
//        formatter.dateFormat = "yyyy-MM-dd HH:mm:ss ZZZ"
    ...
    func toStringWithRelativeTime(strings _: [RelativeTimeStringType: String]? = nil) -> String {
