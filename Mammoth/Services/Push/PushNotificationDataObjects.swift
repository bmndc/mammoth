...
public extension PushNotificationSubscriptionRequest {
...
public extension PushNotificationState {
    func with(subscription: PushNotificationSubscription) -> PushNotificationState {
        return .init(
            receiver: receiver,
            subscription: subscription,
    ...
    func with(alerts: PushNotificationAlerts) -> PushNotificationState {
        return .init(
            receiver: receiver,
            subscription: .init(
